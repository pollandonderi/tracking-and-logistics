...
<body>
    <div class="container-fluid"> 
        ...
        <div class="col-sm-8 col-md-6 col-lg-6 bg-dark">
            <div class="card d-flex align-items-center " style="height: 100vh;">
            <div class="card" style="width: 42rem;">
            <lottie-player src="https://assets4.lottiefiles.com/packages/lf20_fjv8qxqn.json"  background="transparent"  speed="1"  style="width: 670px; height: 400px;"  loop  autoplay></lottie-player>
  <div class="card-body">
    <h4 class="card-title text-center">Connect Now</h4>
